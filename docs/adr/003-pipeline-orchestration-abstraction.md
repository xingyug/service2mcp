...
The design identifies Temporal as the long-term durable workflow target, but the repository needed a working retryable state machine before operational commitment to Temporal. The current phase prioritizes reliable local execution and a narrow, testable workflow core.
