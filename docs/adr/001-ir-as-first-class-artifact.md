...
Tool Compiler v2 ingests heterogeneous upstream definitions such as OpenAPI, GraphQL, SQL schemas, and discovery-first REST surfaces. The platform also needs durable versioning, diffing, rollback, validation, and deployment metadata that survive any individual extractor or runtime implementation.
