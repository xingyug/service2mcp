"""B-005 integration tests: full black-box pipeline against mock real-world APIs.
...
Each test follows the B-003 pilot pattern:
...
# ---------------------------------------------------------------------------
# Thresholds — these are intentionally lenient for the initial B-005
...
class TestJSONPlaceholderBlackBox:
    """B-005 black-box validation against JSONPlaceholder (REST discovery)."""
...
class TestPetStoreBlackBox:
    """B-005 black-box validation against PetStore v3 (OpenAPI spec-first)."""
