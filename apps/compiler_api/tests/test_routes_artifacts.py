...
class TestCreateArtifactVersion:
    async def test_successful_creation(self, _mock_audit_log) -> None:
        ...
        mock_payload.tenant = None
        mock_payload.environment = None
...
class TestScopeAccessArtifacts:
    """Verify tenant/environment authorization on artifact routes."""
    ...
    async def test_admin_can_access_any_tenant(self) -> None:
        ...
        with patch(
            ...
            mock_repo = AsyncMock()
            mock_repo_class.return_value = mock_repo
            mock_repo.list_versions.return_value = MagicMock(spec=ArtifactVersionListResponse)
    ...
    async def test_no_scope_claim_no_tenant_requested(self) -> None:
        ...
        with patch(
            ...
            mock_repo = AsyncMock()
            mock_repo_class.return_value = mock_repo
            mock_repo.get_version.return_value = MagicMock(spec=ArtifactVersionResponse)
    ...
    async def test_mismatched_environment_claim_raises_403(self) -> None:
        ...
        caller = TokenPrincipalResponse(
            ...
            username=None,
            token_type="jwt",
            claims={"sub": "user", "environment": "staging"},
        )
    ...
    async def test_tenants_list_claim_allows_matching_tenant(self) -> None:
        ...
        caller = TokenPrincipalResponse(
            ...
            username=None,
            token_type="jwt",
            claims={"sub": "user", "tenants": ["team-a", "team-b"]},
        )
