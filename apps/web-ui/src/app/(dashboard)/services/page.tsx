...
import { useServices, useDeleteService } from "@/hooks/use-api";
import {
...
export default function ServicesPage() {
  ...
  const [deleteTarget, setDeleteTarget] = React.useState<ServiceSummary | null>(null);
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              <strong>{deleteTarget?.name}</strong> and all its versions from
            ...
            <AlertDialogAction
              ...
              onClick={() => {
                ...
                deleteMutation.mutate(
                  {
                    serviceId: deleteTarget.service_id,
                    scope: {
                      tenant: deleteTarget.tenant ?? undefined,
                      environment: deleteTarget.environment ?? undefined,
                    },
                  },
