...
class PolicyCreateRequest(BaseModel):
    ...
    subject_type: str = Field(min_length=1, max_length=255)
    subject_id: str = Field(min_length=1, max_length=255)
    resource_id: str = Field(min_length=1, max_length=1024)
    action_pattern: str = Field(min_length=1, max_length=1024)
...
class PolicyUpdateRequest(BaseModel):
    ...
    action_pattern: str | None = Field(default=None, max_length=1024)
